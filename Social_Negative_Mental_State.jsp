...
AND IMPLICATIONS</span></a></h1>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 align="center" class="style6 style7">View Mental Disorder State Monitoring Details on Post..</h2>
...
<%
	...
	String s1="",s2="",s3="",s4="",s5="",s6="",s7="", pos="Mental",s22="" ;
	...
	try
	{
				...
				while ( rs.next() )
			   {
					...
					s22=rs.getString(4); //uname
					s3=rs.getString(7); //  pdesc
					s5=rs.getString(8);  // Date
			       ...
			       String sql1="select * from filter where category='"+pos+"' ";
					...
					while ( rs1.next() )
			             ...
			             String t2=rs1.getString(2).toLowerCase();
							  ...
							  if ((s33.toLowerCase().contains(t2)))
									{ 
							  ...
							  <td width="98" height="44" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style32 style5 style11 style14"><strong><%=i%></strong></div></td>
								...
								<td width="200" height="44" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style32 style5 style11 style14"><strong><%=s33%></strong></div></td>
