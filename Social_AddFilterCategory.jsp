...
<head>
<title>Add Filter Category Page</title>
...
AND IMPLICATIONS</span></a></h1>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Add Filter Category..</h2>
        <form action="Social_AddFilterCategory1.jsp" method="post" enctype="multipart/form-data">
                    <table width="410" border="0" align="center"  cellpadding="0" cellspacing="0" >
                      <tr>
                        <td  width="100" valign="middle" height="55" style="color: #2c83b0;"><div align="left" class="style5" style="margin-left:20px;"><b>Add Category</b></div></td>
                      ...
                      <div >
                        <tr>
                          <td height="30" colspan="2" id="learn_more" align="center"  style="color:#FFFFFF;"><p>
                            <input name="submit" type="submit" style="width:100px; height:25px; background-color:#CC6600; color:#FFFFFF;" value="Add"/>
                          </p>
                            <p>&nbsp;</p>
                            <p><a href="Social_ViewCategoryList.jsp" class="style6"><strong>View Category List</strong></a> </p></td>
                        </tr>
                      </div>
                    </table>
		          </form>
